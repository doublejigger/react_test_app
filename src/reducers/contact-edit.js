...
export default (state, action) => {
  ...
  switch (action.type) {
    ...
    case "CONTACT_EDIT_SET_IS_LOADING_STATUS":
      return { ...state, isLoading: action.payload};


    case "CONTACT_EDIT_SET_FORM_DETAILS": {
      let retHash = validateDetailForm(action.payload);
    ...
    case "CONTACT_EDIT_SET_OPTION_COUNTRY_LIST": {
      return { ...state,
        options: {
    ...
    case "CONTACT_EDIT_REDUCER_RESET":
      return resetReducer();
